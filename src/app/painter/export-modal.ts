...
export class ExportModal extends Modal {
  ...
  private onExport: (folderPath: string, previewCanvas: HTMLCanvasElement) => Promise<void>;
  ...
  constructor(
    ...
    plugin: any,
    layers: Layer[], 
    onExport: (folderPath: string, previewCanvas: HTMLCanvasElement) => Promise<void>
  ) {
    super(app);
    this.plugin = plugin;
    this.layers = layers;
  ...
  private renderContent() {
    ...
    const previewCanvas = createPreviewCanvas(this.layers);
    ...
    new Setting(contentEl)
      .addButton(button => {
        ...
        button.onClick(async () => {
          await this.onExport(this.selectedFolder, previewCanvas);
          this.close();
        });
      });
  }
